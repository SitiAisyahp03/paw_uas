...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Mumtaz | Toko Online</title> 
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Gaun Modern</h2>
	...
	<div id="wrapper">
        ...
        <!--<div class="title"><h3>Keranjang Anda</h3></div>
            <div class="hero-unit">
      		...
      		<div class="row">
	<?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM produk WHERE jenis='Modern' order by kode DESC");
				...
				<div class="span9">
					...
					<div id="footer-menu-links">
						...
						<ul id="footer-nav">
							...
							<li><a href="#">Jas Pengantin</a></li>s
