                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-produk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                            ...
                            <option value="Modern">Gaun Modern</option>
                            <option value="Baju Adat">Baju Pengantin Adat </option>
                            <option value="Kebaya">Baju Kebaya</option>
                            <option value="Jas">Jas Pengantin</option>
